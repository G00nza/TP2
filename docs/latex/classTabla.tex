...
\hypertarget{classTabla_aa06ea30404464606d6f3b71c66a78809}{\index{Tabla@{Tabla}!Tabla@{Tabla}}
\index{Tabla@{Tabla}!Tabla@{Tabla}}
\subsubsection[{Tabla}]{\setlength{\rightskip}{0pt plus 5cm}Tabla\-::\-Tabla (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classTabla_aa06ea30404464606d6f3b71c66a78809}


Constructor sin parametros de una tabla trivial. 
...
\end{DoxyDescription}\hypertarget{classTabla_a5a7be353082561e06a877b2255c0ea5c}{\index{Tabla@{Tabla}!Tabla@{Tabla}}
\index{Tabla@{Tabla}!Tabla@{Tabla}}
\subsubsection[{Tabla}]{\setlength{\rightskip}{0pt plus 5cm}Tabla\-::\-Tabla (
\begin{DoxyParamCaption}
...
\begin{DoxyDescription}
\item[Complejidad Temporal]$O$(1)
\end{DoxyDescription}\hypertarget{classTabla_a6d13f7fd32f4ea1eb9f8cf3bdbeb9439}{\index{Tabla@{Tabla}!tipos@{tipos}}
\index{tipos@{tipos}!Tabla@{Tabla}}
\subsubsection[{tipos}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf string\-\_\-map}$<$ {\bf Dato} $>$ \& Tabla\-::tipos (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}\label{classTabla_a6d13f7fd32f4ea1eb9f8cf3bdbeb9439}


Tipos de los campos de la tabla. 
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
( $\forall$ c\-: Campo) c $\in$ campos(this) $\land$ def?(c, res) $\Rightarrow$ tipo\-Campo?(c, this) = obtener(c, res)
\end{DoxyPostcond}
