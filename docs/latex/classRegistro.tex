...
\begin{DoxyDescription}
\item[Complejidad Temporal]$O$(1)
\end{DoxyDescription}\hypertarget{classRegistro_a332ce24bb26d794783172cf9fc327b8b}{\index{Registro@{Registro}!datos@{datos}}
\index{datos@{datos}!Registro@{Registro}}
\subsubsection[{datos}]{\setlength{\rightskip}{0pt plus 5cm}const {\bf string\-\_\-map}$<${\bf Dato}$>$\& Registro\-::datos (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const}}\label{classRegistro_a332ce24bb26d794783172cf9fc327b8b}


Devuelve el diccionario de datos para campo. 
