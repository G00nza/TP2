...
\item 
\hypertarget{classBaseDeDatos_aa6967041c325b137b3e785a65fee4185}{\hyperlink{classstring__map}{string\-\_\-map}$<$ \hyperlink{classstring__map}{string\-\_\-map}$<$ \hyperlink{classBaseDeDatos_a5672205542180582d4fb39817e6753e0}{Indice} $>$ $>$ {\bfseries \-\_\-indices}}\label{classBaseDeDatos_aa6967041c325b137b3e785a65fee4185}

\item 
\hypertarget{classBaseDeDatos_a35f16e1ebd5dde09ad20115b1607776d}{\hyperlink{structBaseDeDatos_1_1Join}{Join} $\ast$ {\bfseries \-\_\-ultimo\-\_\-join}}\label{classBaseDeDatos_a35f16e1ebd5dde09ad20115b1607776d}
...
\begin{DoxyDescription}
\item[Complejidad Temporal]O(c $\ast$ n $\ast$ L)
...
\end{DoxyPostcond}
\hypertarget{classBaseDeDatos_a880168af66cefb35fc13111d64b41e5d}{\index{Base\-De\-Datos@{Base\-De\-Datos}!agregar\-A\-Indice@{agregar\-A\-Indice}}
\index{agregar\-A\-Indice@{agregar\-A\-Indice}!BaseDeDatos@{Base\-De\-Datos}}
\subsubsection[{agregar\-A\-Indice}]{\setlength{\rightskip}{0pt plus 5cm}void Base\-De\-Datos\-::agregar\-A\-Indice (
\begin{DoxyParamCaption}
\item[{{\bf Base\-De\-Datos\-::\-Indice} \&}]{indice, }
\item[{const {\bf Registro} \&}]{registro, }
\item[{const string \&}]{campo}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classBaseDeDatos_a880168af66cefb35fc13111d64b41e5d}


Agrega un registro a un índice dado. 


\begin{DoxyParams}{Parámetros}
{\em indice} & Indice a modificar \\
\hline
{\em registro} & \hyperlink{classRegistro}{Registro} a agregar \\
\hline
{\em campo} & Nombre del campo del indice\\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
( $\forall$ r\-: \hyperlink{classRegistro}{Registro}) (( $\exists$ d\-: \hyperlink{classDato}{Dato}) def?(d, indice) $\land$ obtener(d, indice) = r) $\Rightarrow$ campos(r) = campos(registro) $\land$ ( $\forall$ c\-: campo) c $\in$ campos(r) $\Rightarrow$ tipo(valor(c,r)) = tipo(valor(c, registro))
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
(def?(valor(campo, registro), indice) $\Rightarrow$ indice = definir(valor(campo, registro), Ag(registro, obtener(valor(campo,registro))), indice) ) $\land$ ¬def?(valor(campo, registro), indice) $\Rightarrow$ indice = definir(valor(campo, registro), registro) 
\end{DoxyPostcond}
...
\begin{DoxyDescription}
\item[Complejidad Temporal]$O$(copy(reg) + C$\ast$(L+log(m)))
...
\end{DoxyDescription}\hypertarget{classBaseDeDatos_a9ec2a34b6864548e9e34d2f3142daa44}{\index{Base\-De\-Datos@{Base\-De\-Datos}!crear\-Indice@{crear\-Indice}}
\index{crear\-Indice@{crear\-Indice}!BaseDeDatos@{Base\-De\-Datos}}
\subsubsection[{crear\-Indice}]{\setlength{\rightskip}{0pt plus 5cm}void Base\-De\-Datos\-::crear\-Indice (
\begin{DoxyParamCaption}
\item[{const string \&}]{nombre, }
\item[{const string \&}]{campo}
\end{DoxyParamCaption}
)}}\label{classBaseDeDatos_a9ec2a34b6864548e9e34d2f3142daa44}


Crea un índice para una tabla de la base de datos en un campo de la misma. 


\begin{DoxyParams}{Parámetros}
{\em nombre} & Nombre de la tabla \\
\hline
{\em campo} & Nombre del campo\\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
nombre $\in$ \-\_\-nombres\-\_\-tablas $\land$ campo $\in$ campos(dame\-Tabla(nombre,bd)) $\land$ bd = bd' 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
tiene\-Indice?(nombre, campo, bd)
\end{DoxyPostcond}

\begin{DoxyDescription}
\item[Complejidad Temporal]$O$(m\mbox{[}L+log(m)\mbox{]})
\end{DoxyDescription}chamuyo (ver) \hypertarget{classBaseDeDatos_aee0685f94a16b05b2893b24349716292}{\index{Base\-De\-Datos@{Base\-De\-Datos}!crear\-Tabla@{crear\-Tabla}}
...
\begin{DoxyDescription}
\item[Complejidad Temporal]$O$(cr $\ast$ C)
...
\begin{DoxyDescription}
\item[Complejidad Temporal]O(1)
\end{DoxyDescription}\hypertarget{classBaseDeDatos_a90db1eea7c903c7c736abd45eea0e855}{\index{Base\-De\-Datos@{Base\-De\-Datos}!join@{join}}
\index{join@{join}!BaseDeDatos@{Base\-De\-Datos}}
\subsubsection[{join}]{\setlength{\rightskip}{0pt plus 5cm}Base\-De\-Datos\-::join\-\_\-iterator Base\-De\-Datos\-::join (
\begin{DoxyParamCaption}
\item[{const string \&}]{tabla1, }
\item[{const string \&}]{tabla2, }
\item[{const string \&}]{campo}
\end{DoxyParamCaption}
)}}\label{classBaseDeDatos_a90db1eea7c903c7c736abd45eea0e855}


Crea un join entre las dos tablas y devuelve join\-\_\-begin(res) 
...
\hline
{\em campo} & Nombre del campo sobre el cual realizar el join\\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
tabla1 $\in$ \-\_\-nombres\-\_\-tablas $\land$ campo $\in$ campos(dame\-Tabla(tabla1)) $\land$ tabla2 $\in$ \-\_\-nombres\-\_\-tablas $\land$ campo $\in$ campos(dame\-Tabla(tabla2)) $\land$ (tiene\-Indice?(tabla1, campo, bd)  tiene\-Indice?(tabla2, campo, bd)) 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
El iterador itera sobre los registros de join(t,t2,c,db) en un orden no definido
\end{DoxyPostcond}

\begin{DoxyDescription}
\item[Complejidad Temporal]$O$(n$\ast$\mbox{[}L+log(m)\mbox{]})
\end{DoxyDescription}\hypertarget{classBaseDeDatos_a260e3becd45c0746093991816a8387f4}{\index{Base\-De\-Datos@{Base\-De\-Datos}!join\-\_\-begin@{join\-\_\-begin}}
\index{join\-\_\-begin@{join\-\_\-begin}!BaseDeDatos@{Base\-De\-Datos}}
\subsubsection[{join\-\_\-begin}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Join\-::iterator} Base\-De\-Datos\-::join\-\_\-begin (
\begin{DoxyParamCaption}
\item[{{\bf Join}}]{join}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classBaseDeDatos_a260e3becd45c0746093991816a8387f4}


Devuelve un iterador al primer registro de un join. 


\begin{DoxyParams}{Parámetros}
{\em join} & \hyperlink{structBaseDeDatos_1_1Join}{Join} sobre el cual queremos iterar\\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondición}
True
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
Devuelve el iterador del join 
\end{DoxyPostcond}
\hypertarget{classBaseDeDatos_a451ef7b34a2ff9d395da10745266b703}{\index{Base\-De\-Datos@{Base\-De\-Datos}!registro\-Valido@{registro\-Valido}}
